                        ...
                        <main>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php include 'cabai2.php'; // Memanggil data dari database ?>
                                        <?php foreach ($datacb2 as $rowcb2): ?>
                                            <tr>
                                                <td><?= $rowcb2['tanggal']; ?></td>
                                                <td><?= $rowcb2['tinggi']. " cm"; ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
                            ...
                            <div class="card mb-4">
                                ...
                                <?php
                                        ...
                                        include 'chartcabai2.php';

                                        // Mengonversi data ke format JSON
                                        $json_data = json_encode($datac2);
                                        ?>
                                 <?php
                                        // Menggunakan include untuk menyisipkan file get_data.php
                                        include 'chartcabai22.php';

                                        // Mengonversi data ke format JSON
                                        $json_datac22 = json_encode($datac22);
                                        ?>
                                        
                                <script>

                                     // Data untuk grafik area (misalnya data pertumbuhan tanaman cabai)
                                        var datatinggi = <?php include 'chartcabai2.php'; echo $json_data; ?>;
                                        var datatanggal = <?php include 'chartcabai22.php'; echo $json_datac22; ?>;
