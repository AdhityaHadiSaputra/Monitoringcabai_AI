                        ...
                        <main>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php include 'cabai3.php'; // Memanggil data dari database ?>
                                        <?php foreach ($datacb3 as $rowcb3): ?>
                                            <tr>
                                                <td><?= $rowcb3['tanggal']; ?></td>
                                                <td><?= $rowcb3['tinggi']. " cm"; ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
                            ...
                            <div class="card mb-4">
                                ...
                                <?php
                                        ...
                                        include 'chartcabai3.php';

                                        // Mengonversi data ke format JSON
                                        $json_data = json_encode($datac3);
                                        ?>
                                <?php
                                        // Menggunakan include untuk menyisipkan file get_data.php
                                        include 'chartcabai33.php';

                                        // Mengonversi data ke format JSON
                                        $json_datac33 = json_encode($datac33);
                                        ?>
                                        
                                <script>

                                     // Data untuk grafik area (misalnya data pertumbuhan tanaman cabai)
                                        var datatinggi = <?php include 'chartcabai3.php'; echo $json_data; ?>;
                                        var datatanggal = <?php include 'chartcabai33.php'; echo $json_datac33; ?>;
